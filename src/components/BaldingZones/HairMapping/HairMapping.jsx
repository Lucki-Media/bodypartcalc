                        ...
                        <form >
                            <div className={styles.input_style_fiels}>
                                <label htmlFor="Minimal">
                                    <input type="radio" name="hairZone" id='Minimal' value="Minimal"  checked />
                                    Minimal</label></div>
                            <div className={styles.input_style_fiels}>
                                <label htmlFor="Moderate">
                                    <input type="radio" name="hairZone" id='Moderate' value="Moderate" />Moderate</label></div>
                            <div className={styles.input_style_fiels}>
                                <label htmlFor="Severe">
                                    <input type="radio" name="hairZone" id='Severe' value="Severe" />
                                    Severe
                                </label>
                            </div>
                        </form>
                        <div className={styles.hairMapping_Select_btn}>
                            <button onClick={handlePopupClose} className={styles.submit_button}>Select</button></div>
                        <div>
