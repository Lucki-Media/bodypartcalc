...
const ResultFinalBlock = ({onPrev , selectedBodyPartCB}) => {
  ...
  const getProductData = async () => {
    ...
    https://dev.luckistore.in/build-my-hair/wp-json/bmh-get-product-list-api/v1/data?bodypart=Face&category=17,18&tag=&per_page=30&orderby=title&order=asc
    
    fetch(`${process.env.REACT_APP_URL}` + "/wp-json/bmh-get-product-list-api/v1/data?bodypart=Face")
...
console.log('selectedBodyPartCB');
console.log(selectedBodyPartCB);
