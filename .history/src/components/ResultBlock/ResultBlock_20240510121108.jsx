...
const ResultBlock = ({onNext}) => {
  ...
  const [getHairType, setHairType] = useState(gethairTypecookies.hairType);
  const [getHairColor, setHairColor] = useState(gethairColorcookies.hairColor);

  console.log(getHairZones);
  console.log(getHairZones);

  console.log(getSkinTone);
  console.log(getSkinTone);

  console.log(getHairType);
  console.log(getHairType);
