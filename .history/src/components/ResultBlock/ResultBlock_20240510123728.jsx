  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_URL}` + "/wp-json/bmh-hair-modifier-graph/v1/data")
      ...
      .then(data => {
        ...
        // Find matching hair data from API response based on skin tone, hair type, and hair color
        ...
        // If matching hair data is found, calculate the multiplier value and multiply it with the total cost
        if (matchedHair) {
