...
const HorizontalTab = ({onNext , onTabSelect , bodypartcallback }) => {
  ...
  const [checkCookie, setCheckCookie] = useCookies(["hairZone"]);
    ...
    <>
      ...
      <div className="bb_navigation_page_button">
        <div className="bb_redirect_next_btn">
          <button className={`bb_button ${cookies.hairZone === [] ? styles.check_btn_disabled : '' }`} onClick={onNext}>
            Next 
          </button>
        </div>
      </div>
